package com.example.android.fivepoints;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void Click(View view) {
        switch (view.getId()) {
            case R.id.l11: checkPoint(1,1);
                break;
            case R.id.l12: checkPoint(1,2);
                break;
            case R.id.l13: checkPoint(1,3);
                break;
            case R.id.l14: checkPoint(1,4);
                break;
            case R.id.l15: checkPoint(1,5);
                break;
            case R.id.l21: checkPoint(2,1);
                break;
            case R.id.l22: checkPoint(2,2);
                break;
            case R.id.l23: checkPoint(2,3);
                break;
            case R.id.l24: checkPoint(2,4);
                break;
            case R.id.l25: checkPoint(2,5);
                break;
            case R.id.l31: checkPoint(3,1);
                break;
            case R.id.l32: checkPoint(3,2);
                break;
            case R.id.l33: checkPoint(3,3);
                break;
            case R.id.l34: checkPoint(3,4);
                break;
            case R.id.l35: checkPoint(3,5);
                break;
            case R.id.l41: checkPoint(4,1);
                break;
            case R.id.l42: checkPoint(4,2);
                break;
            case R.id.l43: checkPoint(4,3);
                break;
            case R.id.l44: checkPoint(4,4);
                break;
            case R.id.l45: checkPoint(4,5);
                break;
            case R.id.l51: checkPoint(5,1);
                break;
            case R.id.l52: checkPoint(5,2);
                break;
            case R.id.l53: checkPoint(5,3);
                break;
            case R.id.l54: checkPoint(5,4);
                break;
            case R.id.l55: checkPoint(5,5);
                break;
        }
